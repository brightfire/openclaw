...
| ------------------------------ | ------------------------------------------ | ------------- | ----------------------------------------------- | ------------ |
| Upstream Test Fixes            | `brightfire/upstream-test-fixes`           | `7d10e8a4e48` | https://github.com/brightfire/openclaw/pull/150 | 2026-08-25   |
...
| Bundle All Plugins             | `brightfire/bundle-all-plugins`            | `9d89a005d34` | —                                               | 2026-08-25   |
