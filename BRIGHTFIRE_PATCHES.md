...
| feat(otel): combine otel-agent-identity + skill-used-version into otel-improvements | `brightfire/otel-improvements` | `3c4e6adfea` | https://github.com/brightfire/openclaw/pull/153 | 2026-07-14 |
