...
| CLI HTTP Health Fallback | `brightfire/cli-http-fallback` | `db87bbb616` | — | 2026-08-24 |
...
| OTEL Improvements | `brightfire/otel-improvements` | `229c1058ab` | https://github.com/brightfire/openclaw/pull/173 | 2026-08-24 |
