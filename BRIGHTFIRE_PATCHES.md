...
| feat(otel): combine otel-agent-identity + skill-used-version into otel-improvements | `brightfire/otel-improvements` | `dec9003b0a` | https://github.com/brightfire/openclaw/pull/157 | 2026-07-14 |
