...
export const ja_JP: TranslationMap = {
  ...
  skillWorkshop: {
    ...
    header: {
      ...
      useCurrentChatTooltip:
        "修正リクエストを、提案のワークショップセッションではなく現在のチャットセッションに送信します。",
    },
  },
  activity: {
    title: "アクティビティ",
  ...
  workboard: {
    ...
    dependenciesBlockedTitle: "依存関係の待機中: {parents}。",
    dependencyMissing: "{parent} (見つかりません)",
    dependencyStatusMissing: "不足",
    unknownStatus: "不明",
  ...
  chat: {
    ...
    workspaceFiles: {
      ...
      expand: "Workspace ファイルを展開",
      collapse: "Workspace ファイルを折りたたむ",
      workspace: "Workspace",
      files: "ファイル",
      refresh: "ファイルを更新",
      loading: "ファイルを読み込み中…",
      empty: "Workspace ファイルがありません",
      missing: "不足",
    },
  },
  languages: {
