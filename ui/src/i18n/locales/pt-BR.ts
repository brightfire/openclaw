...
export const pt_BR: TranslationMap = {
  ...
  logsView: {
    title: "Logs",
    subtitle: "Logs de arquivos do Gateway (JSONL).",
    ...
    autoFollow: "Acompanhamento automático",
    file: "Arquivo: {file}",
    truncated: "Saída do log truncada; mostrando o trecho mais recente.",
  ...
  chat: {
    ...
    workspaceFiles: {
      ...
      expand: "Expandir arquivos do workspace",
      collapse: "Recolher arquivos do workspace",
      workspace: "Workspace",
      files: "Arquivos",
      refresh: "Atualizar arquivos",
      loading: "Carregando arquivos…",
      empty: "Nenhum arquivo no workspace",
      missing: "Ausente",
    },
  },
  languages: {
