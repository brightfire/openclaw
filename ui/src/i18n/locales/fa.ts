...
export const fa: TranslationMap = {
  ...
  logsView: {
    title: "لاگ‌ها",
    subtitle: "لاگ‌های فایل Gateway (JSONL).",
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "فایل‌های Workspace",
      expand: "باز کردن فایل‌های Workspace",
      collapse: "بستن فایل‌های Workspace",
      workspace: "Workspace",
      files: "فایل‌ها",
      refresh: "تازه‌سازی فایل‌ها",
      loading: "در حال بارگذاری فایل‌ها…",
      empty: "هیچ فایل Workspace وجود ندارد",
      missing: "موجود نیست",
    },
  },
  languages: {
