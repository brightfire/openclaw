...
export const vi: TranslationMap = {
  ...
  skillWorkshop: {
    ...
    header: {
      ...
      useCurrentChatAria: "Dùng cuộc trò chuyện hiện tại cho các yêu cầu chỉnh sửa",
  ...
  logsView: {
    ...
    autoFollow: "Tự động theo dõi",
    file: "Tệp: {file}",
    truncated: "Đầu ra nhật ký đã bị cắt ngắn; đang hiển thị phần mới nhất.",
  ...
  workboard: {
    ...
    detailNotePlaceholder: "Thêm ghi chú về quyết định, điểm nghẽn hoặc bằng chứng...",
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "Tệp workspace",
      expand: "Mở rộng tệp workspace",
      collapse: "Thu gọn tệp workspace",
      workspace: "Workspace",
      files: "Tệp",
      refresh: "Làm mới tệp",
      loading: "Đang tải tệp…",
      empty: "Không có tệp workspace",
      missing: "Thiếu",
    },
  },
  languages: {
