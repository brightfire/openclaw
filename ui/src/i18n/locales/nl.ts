...
export const nl: TranslationMap = {
  ...
  logsView: {
    title: "Logs",
    subtitle: "Gateway-bestandslogs (JSONL).",
    ...
    filter: "Filter",
    searchPlaceholder: "Logs zoeken",
    autoFollow: "Automatisch volgen",
    file: "Bestand: {file}",
    truncated: "Loguitvoer afgekapt; nieuwste deel wordt weergegeven.",
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "Werkruimtebestanden",
      expand: "Werkruimtebestanden uitvouwen",
      collapse: "Werkruimtebestanden samenvouwen",
      workspace: "Werkruimte",
      files: "Bestanden",
      refresh: "Bestanden vernieuwen",
      loading: "Bestanden laden…",
      empty: "Geen werkruimtebestanden",
      missing: "Ontbreekt",
    },
  },
  languages: {
