...
export const pl: TranslationMap = {
  ...
  logsView: {
    ...
    autoFollow: "Automatyczne śledzenie",
    file: "Plik: {file}",
    truncated: "Dane wyjściowe logu zostały obcięte; wyświetlany jest najnowszy fragment.",
    empty: "Brak wpisów logu.",
  },
  workboard: {
    ...
    dependenciesReadyTitle: "{count} zależności ukończono.",
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "Pliki obszaru roboczego",
      expand: "Rozwiń pliki obszaru roboczego",
      collapse: "Zwiń pliki obszaru roboczego",
      workspace: "Obszar roboczy",
      files: "Pliki",
      refresh: "Odśwież pliki",
      loading: "Ładowanie plików…",
      empty: "Brak plików obszaru roboczego",
      missing: "Brak",
    },
  },
  languages: {
