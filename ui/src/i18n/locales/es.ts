...
export const es: TranslationMap = {
  ...
  logsView: {
    ...
    autoFollow: "Seguimiento automático",
    file: "Archivo: {file}",
    truncated: "Salida del registro truncada; se muestra el fragmento más reciente.",
  ...
  workboard: {
    ...
    detailAutomationBoard: "Panel: {board}",
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "Archivos del espacio de trabajo",
      expand: "Expandir archivos del espacio de trabajo",
      collapse: "Contraer archivos del espacio de trabajo",
      workspace: "Espacio de trabajo",
      files: "Archivos",
      refresh: "Actualizar archivos",
      loading: "Cargando archivos…",
      empty: "No hay archivos del espacio de trabajo",
      missing: "Faltante",
    },
  },
  languages: {
