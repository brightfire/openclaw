...
export const ar: TranslationMap = {
  ...
  skillWorkshop: {
    ...
    header: {
      useCurrentChat: "استخدم الدردشة الحالية",
      useCurrentChatAria: "استخدم الدردشة الحالية لطلبات المراجعة",
  ...
  workboard: {
    ...
    dependenciesReadyTitle: "اكتملت {count} تبعيات.",
  ...
  chat: {
    ...
    workspaceFiles: {
      ...
      expand: "توسيع ملفات مساحة العمل",
      collapse: "طي ملفات مساحة العمل",
      workspace: "مساحة العمل",
      files: "الملفات",
      refresh: "تحديث الملفات",
      loading: "جارٍ تحميل الملفات…",
      empty: "لا توجد ملفات في مساحة العمل",
      missing: "مفقود",
    },
  },
  languages: {
