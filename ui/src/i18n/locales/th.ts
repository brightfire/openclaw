...
export const th: TranslationMap = {
  ...
  workboard: {
    ...
    detailOperatorNotes: "หมายเหตุจากผู้ปฏิบัติงาน",
    detailNoNotes: "ยังไม่มีหมายเหตุจากผู้ปฏิบัติงาน",
    ...
    dependenciesReadyTitle: "สิ่งที่ต้องพึ่งพาเสร็จสิ้นแล้ว {count} รายการ",
    dependenciesBlocked: "ถูกบล็อก {count} รายการ",
    dependenciesBlockedTitle: "กำลังรอสิ่งที่ต้องพึ่งพา: {parents}",
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "ไฟล์เวิร์กสเปซ",
      expand: "ขยายไฟล์เวิร์กสเปซ",
      collapse: "ยุบไฟล์เวิร์กสเปซ",
      workspace: "เวิร์กสเปซ",
      files: "ไฟล์",
      refresh: "รีเฟรชไฟล์",
      loading: "กำลังโหลดไฟล์…",
      empty: "ไม่มีไฟล์เวิร์กสเปซ",
      missing: "ขาดหาย",
    },
  },
  languages: {
