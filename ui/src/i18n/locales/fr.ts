...
export const fr: TranslationMap = {
  ...
  skillWorkshop: {
    ...
    header: {
      useCurrentChat: "Utiliser la conversation actuelle",
      useCurrentChatAria: "Utiliser la conversation actuelle pour les demandes de révision",
      useCurrentChatTooltip:
        "Envoyer les demandes de révision à la session de conversation actuelle au lieu de la session d’atelier de la proposition.",
    },
  },
  activity: {
    title: "Activité",
  ...
  logsView: {
    ...
    autoFollow: "Suivi automatique",
    file: "Fichier : {file}",
    truncated: "Sortie du journal tronquée ; affichage du dernier bloc.",
  ...
  workboard: {
    ...
    dependencyStatusMissing: "Manquant",
  ...
  chat: {
    ...
    workspaceFiles: {
      ...
      expand: "Développer les fichiers de l’espace de travail",
      collapse: "Réduire les fichiers de l’espace de travail",
      workspace: "Espace de travail",
      files: "Fichiers",
      refresh: "Actualiser les fichiers",
      loading: "Chargement des fichiers…",
      empty: "Aucun fichier d’espace de travail",
      missing: "Manquant",
    },
  },
  languages: {
