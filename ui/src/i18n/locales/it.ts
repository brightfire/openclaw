...
export const it: TranslationMap = {
  ...
  skillWorkshop: {
    ...
    header: {
      useCurrentChat: "Usa chat corrente",
  ...
  logsView: {
    title: "Log",
    subtitle: "Log dei file Gateway (JSONL).",
    ...
    autoFollow: "Segui automaticamente",
    file: "File: {file}",
    truncated: "Output dei log troncato; viene mostrato il blocco più recente.",
  ...
  workboard: {
    ...
    detailNoNotes: "Ancora nessuna nota dell'operatore.",
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "File dell'area di lavoro",
      expand: "Espandi i file dell'area di lavoro",
      collapse: "Comprimi i file dell'area di lavoro",
      workspace: "Area di lavoro",
      files: "File",
      refresh: "Aggiorna file",
      loading: "Caricamento dei file…",
      empty: "Nessun file nell'area di lavoro",
      missing: "Mancante",
    },
  },
  languages: {
