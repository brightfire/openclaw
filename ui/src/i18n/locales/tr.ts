...
export const tr: TranslationMap = {
  ...
  logsView: {
    ...
    autoFollow: "Otomatik takip",
    file: "Dosya: {file}",
    truncated: "Günlük çıktısı kısaltıldı; en son parça gösteriliyor.",
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "Çalışma alanı dosyaları",
      expand: "Çalışma alanı dosyalarını genişlet",
      collapse: "Çalışma alanı dosyalarını daralt",
      workspace: "Çalışma alanı",
      files: "Dosyalar",
      refresh: "Dosyaları yenile",
      loading: "Dosyalar yükleniyor…",
      empty: "Çalışma alanı dosyası yok",
      missing: "Eksik",
    },
  },
  languages: {
