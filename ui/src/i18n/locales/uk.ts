...
export const uk: TranslationMap = {
  ...
  skillWorkshop: {
    ...
    header: {
      ...
      useCurrentChatAria: "Використовувати поточний чат для запитів на доопрацювання",
      useCurrentChatTooltip:
        "Надсилати запити на доопрацювання до поточної сесії чату замість сесії workshop пропозиції.",
    },
  },
  activity: {
    title: "Активність",
  ...
  workboard: {
    ...
    detailWorkerLogs: "Журнали працівника",
    detailWorkerProtocol: "Протокол працівника",
    ...
    dependenciesReady: "{count} готові",
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "Файли робочого простору",
      expand: "Розгорнути файли робочого простору",
      collapse: "Згорнути файли робочого простору",
      workspace: "Робочий простір",
      files: "Файли",
      refresh: "Оновити файли",
      loading: "Завантаження файлів…",
      empty: "Немає файлів робочого простору",
      missing: "Відсутній",
    },
  },
  languages: {
