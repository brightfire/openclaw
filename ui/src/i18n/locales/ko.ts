...
export const ko: TranslationMap = {
  ...
  skillWorkshop: {
    ...
    header: {
      ...
      useCurrentChatTooltip: "제안의 workshop 세션 대신 현재 채팅 세션으로 수정 요청을 보냅니다.",
    },
  },
  activity: {
    title: "활동",
  ...
  workboard: {
    ...
    detailNotePlaceholder: "결정, 차단 요소 또는 증거 메모를 추가하세요...",
    detailAddNote: "메모 추가",
    openSession: "세션 열기",
  ...
  chat: {
    ...
    workspaceFiles: {
      label: "워크스페이스 파일",
      expand: "워크스페이스 파일 펼치기",
      collapse: "워크스페이스 파일 접기",
      workspace: "워크스페이스",
      files: "파일",
      refresh: "파일 새로 고침",
      loading: "파일 로드 중…",
